...
import { Search, Filter, Eye, Check, X, User, ArrowLeft } from "lucide-react";
...
// Zimbabwe-specific mock loan applications data
const loanApplicationsData = [
  ...
  },
  {
    ...
    email: "ngoni.mapfumo@gmail.com",
    phone: "+263 71 678 9012",
    amount: 210000, // ZWL converted to USD (~$300)
    purpose: "Transport Business",
    status: "pending",
  ...
  },
  {
    ...
    email: "priscilla.dube@yahoo.com",
    phone: "+263 78 789 0123",
    amount: 56000, // ZWL converted to USD (~$80)
  ...
  },
  {
    ...
    email: "wellington.chiware@gmail.com",
    phone: "+263 77 890 1234",
    amount: 315000, // ZWL converted to USD (~$450)
...
const LoanApplicationsPage = () => {
  ...
  const handleAction = (type: 'approve' | 'reject', applicationId: string) => {
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card>
            <CardContent className="p-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-warning">{loanApplicationsData.filter(a => a.status === 'pending').length}</p>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-success">{loanApplicationsData.filter(a => a.status === 'approved').length}</p>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-primary">{loanApplicationsData.filter(a => a.status === 'active').length}</p>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-destructive">{loanApplicationsData.filter(a => a.status === 'rejected').length}</p>
